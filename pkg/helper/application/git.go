...
func gitDeploy(ctx context.Context, d DeploymentConfig, cc *client.Client, cleverRemote string) diag.Diagnostics {
...
func _gitDeploy(ctx context.Context, d DeploymentConfig, cc *client.Client, cleverRemote string) diag.Diagnostics {
