...
* **elasticsearch:** add elasticsearch_cluster resource ([d8969ca](https://github.com/CleverCloud/terraform-provider-clevercloud/commit/d8969ca2ba5ef9a20c9a903f047075f8793b8139))
* **elasticsearch:** use named plan (M/L/XL) instead of cpu/memory/disk ([217c6b1](https://github.com/CleverCloud/terraform-provider-clevercloud/commit/217c6b160f892c8bde92ae7c707ff4044311d1d3))
* **elasticsearch:** warn that the cluster product is alpha ([42a26d2](https://github.com/CleverCloud/terraform-provider-clevercloud/commit/42a26d2e2bc35200a7df4356a6c05f13a370116a))
...
* **elasticsearch:** fetch available versions from /v4/elasticsearch/versions ([82e6591](https://github.com/CleverCloud/terraform-provider-clevercloud/commit/82e65911872dc7ed4ded324a43bb3e43a325ca71))
* **elasticsearch:** follow the cluster API changes ([b97df82](https://github.com/CleverCloud/terraform-provider-clevercloud/commit/b97df8251080f0cd411fbfb99382955bd6e33b71))
* **elasticsearch:** poll for connection details after cluster creation ([4e865d2](https://github.com/CleverCloud/terraform-provider-clevercloud/commit/4e865d2514b9e14c1fa99707dfc529ed891bdfa4))
* **elasticsearch:** retry the cluster creation on 5xx ([e1aed54](https://github.com/CleverCloud/terraform-provider-clevercloud/commit/e1aed54789c3a3a52345bf8e69a0d08b4bce2dc7))
