...
page_title: "clevercloud_drain_datadog Resource - terraform-provider-clevercloud"
description: |-
  clevercloud_drain_*
  ...
  US1 (default): https://http-intake.logs.datadoghq.com/v1/inputUS3: https://http-intake.logs.us3.datadoghq.com/v1/inputUS5: https://http-intake.logs.us5.datadoghq.com/v1/inputEU1: https://http-intake.logs.datadoghq.eu/v1/inputAP1: https://http-intake.logs.ap1.datadoghq.com/v1/inputUS1-FED: https://http-intake.logs.ddog-gov.com/v1/input
...
# clevercloud_drain_datadog (Resource)
...
- `api_key` (String, Sensitive) Datadog API key for log ingestion
- `resource_id` (String) Application or product ID which support logs drains

### Optional

- `endpoint` (String) Datadog log intake endpoint URL (without the API key). Defaults to US1 region.
