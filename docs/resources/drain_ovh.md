...
page_title: "clevercloud_drain_ovh Resource - terraform-provider-clevercloud"
description: |-
  clevercloud_drain_*
...
# clevercloud_drain_ovh (Resource)
...
- `token` (String, Sensitive) OVH authentication token
- `url` (String) OVH logs destination URL
